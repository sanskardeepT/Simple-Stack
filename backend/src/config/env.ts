...
const envSchema = z.object({
  ...
  UPSTASH_REDIS_TOKEN: z.string().trim().optional().or(z.literal("")),
  ...
  MSG91_API_KEY: z.string().trim().optional().or(z.literal("")),
  MSG91_SENDER_ID: z.string().trim().optional().or(z.literal("")),
  RAZORPAY_KEY_ID: z.string().trim().optional().or(z.literal("")),
  RAZORPAY_KEY_SECRET: z.string().trim().optional().or(z.literal("")),
  RAZORPAY_PLAN_ID: z.string().trim().optional().or(z.literal("")),
  RAZORPAY_WEBHOOK_SECRET: z.string().trim().optional().or(z.literal("")),
