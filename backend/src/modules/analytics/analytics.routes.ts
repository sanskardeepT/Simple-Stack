...
router.get("/dashboard", authenticate, authorize("analytics:read"), async (req, res) => analyticsController.dashboard(req, res));
router.get("/activity", authenticate, authorize("analytics:read"), async (req, res) => analyticsController.activity(req, res));
