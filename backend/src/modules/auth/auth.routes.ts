...
import { changePasswordSchema, loginSchema, refreshSchema, registerSchema, resendOtpSchema, verifyOtpSchema } from "./auth.schema.js";
...
router.post("/verify-otp", otpRateLimit, validate(verifyOtpSchema), async (req, res) => authController.verifyOtp(req, res));
router.post("/resend-otp", otpRateLimit, validate(resendOtpSchema), async (req, res) => authController.resendOtp(req, res));
